resource "oci_core_vcn" "generated_oci_core_vcn" {
  ...
  display_name   = "oke-vcn-quick-gcn_guide-1049412cc"
  dns_label      = "gcnguide"
}

resource "oci_core_internet_gateway" "generated_oci_core_internet_gateway" {
  compartment_id = var.compartment_ocid
  display_name   = "oke-igw-quick-gcn_guide-1049412cc"
  enabled        = "true"
...
resource "oci_core_nat_gateway" "generated_oci_core_nat_gateway" {
  compartment_id = var.compartment_ocid
  display_name   = "oke-ngw-quick-gcn_guide-1049412cc"
  vcn_id         = oci_core_vcn.generated_oci_core_vcn.id
}

resource "oci_core_service_gateway" "generated_oci_core_service_gateway" {
  compartment_id = var.compartment_ocid
  display_name   = "oke-sgw-quick-gcn_guide-1049412cc"
  services {
    service_id = local.all_services_ocid
  }
  vcn_id = oci_core_vcn.generated_oci_core_vcn.id
}
...
resource "oci_core_route_table" "generated_oci_core_route_table" {
  compartment_id = var.compartment_ocid
  display_name   = "oke-private-routetable-gcn_guide-1049412cc"
  route_rules {
  ...
  route_rules {
    ...
    destination       = local.all_services_cidr_block
...
resource "oci_core_subnet" "service_lb_subnet" {
  ...
  compartment_id             = var.compartment_ocid
  display_name               = "oke-svclbsubnet-quick-gcn_guide-1049412cc-regional"
  dns_label                  = "lbsub530289104"
...
resource "oci_core_subnet" "node_subnet" {
  ...
  compartment_id             = var.compartment_ocid
  display_name               = "oke-nodesubnet-quick-gcn_guide-1049412cc-regional"
  dns_label                  = "subb869f2108"
...
resource "oci_core_subnet" "kubernetes_api_endpoint_subnet" {
  ...
  compartment_id             = var.compartment_ocid
  display_name               = "oke-k8sApiEndpoint-subnet-quick-gcn_guide-1049412cc-regional"
  dns_label                  = "sub47822b25e"
  prohibit_public_ip_on_vnic = "false"
  route_table_id             = oci_core_default_route_table.generated_oci_core_default_route_table.id
...
resource "oci_core_subnet" "developer_subnet" {
  cidr_block                 = "10.0.0.16/28"
  compartment_id             = var.compartment_ocid
  display_name               = "developer_subnet"
  dns_label                  = "developerSubnet"
  prohibit_public_ip_on_vnic = "false"
  route_table_id             = oci_core_default_route_table.generated_oci_core_default_route_table.id
  vcn_id                     = oci_core_vcn.generated_oci_core_vcn.id
}
...
resource "oci_core_default_route_table" "generated_oci_core_default_route_table" {
  display_name = "oke-public-routetable-gcn_guide-1049412cc"
  route_rules {
...
resource "oci_core_security_list" "service_lb_sec_list" {
  compartment_id = var.compartment_ocid
  display_name   = "oke-svclbseclist-quick-gcn_guide-1049412cc"
  vcn_id         = oci_core_vcn.generated_oci_core_vcn.id
}

resource "oci_core_security_list" "node_sec_list" {
  compartment_id = var.compartment_ocid
  display_name   = "oke-nodeseclist-quick-gcn_guide-1049412cc"
...
resource "oci_core_security_list" "kubernetes_api_endpoint_sec_list" {
  compartment_id = var.compartment_ocid
  display_name   = "oke-k8sApiEndpoint-quick-gcn_guide-1049412cc"
  egress_security_rules {
